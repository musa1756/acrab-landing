...
Изображения релизов размещаются в `public/assets/changelog/` и называются по
версии: `1-3.png`, `1-4.png`. Пропорции — 16:10 (например 1600×1000); другое
соотношение рамка `.release-media` обрежет по `object-fit: cover`.
